...
const CompanyDashboardProfile = () => {
  const companyProfile = {
    ...
    country: "Poland",
    established: 2000,
    description: "Tech Solutions Ltd. provides innovative technology solutions to clients worldwide. With over two decades of experience, we pride ourselves on delivering the best in tech services."
  };
  ...
  return (
    <div className="w-full max-w-xl mx-auto">
      <div className='p-6 bg-white rounded-xl'>
        ...
        <h2 className="text-3xl font-semibold mb-8">{companyProfile.companyName}</h2>
        <ul className="space-y-6 text-gray-800">
          ...
          <li className="flex justify-between items-center">
            ...
            <a href={companyProfile.website} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">
          ...
          <li className="flex justify-between items-center">
            <strong className="text-lg font-semibold">Postal Code</strong>
          ...
          <li className="flex justify-between items-center">
            <strong className="text-lg font-semibold">Established</strong>
